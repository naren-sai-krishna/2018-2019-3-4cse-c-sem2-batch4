...
if (isset($_POST['ssubmit'])){
    ...
    $spin=mysqli_real_escape_string($con,$_POST['spin']);
    ...
    $rows = mysqli_num_rows($result);
        ...
        if($rows==1){
            ...
            $query1 = "INSERT INTO user_data(firstname,lastname,phone,email,pass,address_,city) VALUES('$sfirstname','$slastname','$sphone','$semail','$shashed','$saddress','$spin')";
