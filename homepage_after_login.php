    ...
    <head>
        ...
        <style>
            *{
            ...
            header{
                background-image: linear-gradient(rgba(0, 0, 0, 0.8),rgba(0,0,0,0.8)), url('images/Header.jpg');
...
<fieldset class="rating" onclick="starrating()" id="hello">
    ...
    <input type="radio" id="1star3half" name="1rating" value="3.5" /><label class="half" for="1star3half" title="Medium - 3.5 stars"></label>
    <input type="radio" id="1star3" name="1rating" value="3" /><label class = "full" for="1star3" title="Medium - 3 stars"></label>
    ...
    <input type="radio" id="1star1half" name="1rating" value="1.5" /><label class="half" for="1star1half" title="Medium - 1.5 stars"></label>
...
<fieldset class="rating">
    ...
    <input type="radio" id="2star3half" name="2rating" value="3.5" /><label class="half" for="2star3half" title="Medium - 3.5 stars"></label>
    <input type="radio" id="2star3" name="2rating" value="3" /><label class = "full" for="2star3" title="Medium - 3 stars"></label>
    ...
    <input type="radio" id="2star1half" name="2rating" value="1.5" /><label class="half" for="2star1half" title="Medium - 1.5 stars"></label>
...
<fieldset class="rating">
    ...
    <input type="radio" id="3star3half" name="3rating" value="3.5" /><label class="half" for="3star3half" title="Medium - 3.5 stars"></label>
    <input type="radio" id="3star3" name="3rating" value="3" /><label class = "full" for="3star3" title="Medium - 3 stars"></label>
    ...
    <input type="radio" id="3star1half" name="3rating" value="1.5" /><label class="half" for="3star1half" title="Medium - 1.5 stars"></label>
...
<fieldset class="rating" onclick="starrating()">
    ...
    <input type="radio" id="4star3half" name="4rating" value="3.5" /><label class="half" for="4star3half" title="Medium - 3.5 stars"></label>
    <input type="radio" id="4star3" name="4rating" value="3" /><label class = "full" for="4star3" title="Medium - 3 stars"></label>
    ...
    <input type="radio" id="4star1half" name="4rating" value="1.5" /><label class="half" for="4star1half" title="Medium - 1.5 stars"></label>
...
<ul>    
      ...
      <button type="submit" name="ratesubmit" style="float:right" onclick="document.getElementById('id03').style.display='block';location.href('homepage_after_login.php')" class="cancelbtn">Submit</button>
  </form>
</div>
                    ...
                    <ul class="main-nav animated bounce"  id="check-bars">
                        ...
                        <li><a href="sp/index.php" style="font-weight:bold">Cuisines</a>
                        ...
                        <li><a style="font-weight:bold" href="tablereserve1.php">Table Reservation</a></li>
                        <li><a style="font-weight:bold" href="#" onclick="document.getElementById('id03').style.display='block'">Rate Us</a></li>
                        <a style="font-weight:bold" href="php/logout.php" class="btn btn-one logout" >Logout</a>
            ...
            <div class="main-content-header">
                ...
                <div id="content_01" <?php if ($_SESSION['lphone']!="9999999999") { echo 'style="display:none;"'; } ?>>
                <a href="show_tables.php" id="button01" class="btn btn-one">Show Reserved Tables</a>
                <a href="show_orders.php" id="button02" class="btn btn-two">Show Food Orders</a>
                </div>
...
<div class="mySlides fade">
  ...
  <img src="images/Slider1.jpg" style="width:100%;height:100vh;opacity:0.2">
  <div class="text"><div class="_1Vw_y"><img class="_2dYjq" width="105" height="199" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_210,h_398/4x_-_No_min_order_x0bxuf"></div><div class="_3fted">No Minimum Order</div><br><div class="_12i5X">Order in for yourself or for the group, with no restrictions on order value</div></div>
</div>

<div class="mySlides fade">
  <div class="numbertext"></div>
  <img src="images/Slider2.jpg" style="width:100%;height:100vh;opacity:0.2">
  <div class="text"><div class="_1Vw_y"><img class="_2dYjq" width="112" height="206" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_224,h_412/4x_Live_order_zzotwy"></div><div class="_3fted">Book Your Table</div><br><div class="_12i5X">Reserve your table in advance and enjoy a comfortable dine</div></div>
</div>

<div class="mySlides fade">
  <div class="numbertext"></div>
  <img src="images/Slider3.jpg" style="width:100%;height:100vh;opacity:0.2">
  <div class="text"><div class="_1Vw_y"><img class="_2dYjq" width="124" height="188" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_248,h_376/4x_-_Super_fast_delivery_awv7sn"></div><div class="_3fted">Lightning-Fast Delivery</div><br><div class="_12i5X">Experience Relish's superfast delivery for food delivered fresh &amp; on time</div></div>
</div>
...
function showSlides() {
  ...
  setTimeout(showSlides, 4000); // Change image every 2 seconds
    ...
    <div class="part2">
        <footer>
                <div class="footer1" style="padding-top:100px">
                        <div class="appstore" style="margin-right:2%;margin-top:-50px;">
                                <a href="https://itunes.apple.com/in/" rel="nofollow noopener" alt="" target="_blank" class="itunes">
                                <img class="" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/icon-AppStore_lg30tv" width="200px" height="65px" alt=""></a><br>
                                <br><a href="https://play.google.com/store/apps/" rel="nofollow noopener" alt="" target="_blank" class="android">
                                <img class="" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/icon-GooglePlay_1_zixjxl" width="200px" height="65px" alt=""></a>
                            </div>



        <div class="aboutus" style="margin-top:-40px">
            <ul>
            <ul>


                <!-- <li><a class="aboutus2" href="team.html" alt="" target="_blank">Team</a></li> -->
                <li><a class="aboutus4" href="t&c.html" alt="" target="_blank">Terms &amp; Conditions</a></li>
                <li><a class="aboutus5" href="refund.html" alt="" target="_blank">Refund &amp; Cancellation</a></li>
                <li><a class="aboutus6" href="privacy.html" alt="" target="_blank">Privacy Policy</a></li>
            </ul>
            </ul>
        </div>
        ...
        <hr>
        <div style="margin-bottom:10px;text-align:center" class="corp"><b>© 2019 Relish Inc.</b></div>
