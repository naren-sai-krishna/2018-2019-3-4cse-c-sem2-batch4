...
function Validate() {
  var pins = [500020,530005,530001,530002,530003,530004,530007,530008,530009,530011,530012,530013,530014,530015,530016,530017,530018,530020,530022,530024,530026,530027,530028,530029,530031,530032,530035,530040,530041,530043,530044,530045,530046,530047,530048,530049,530051,530052,530075,531019,531020,531021,531035,531163,531173];
        var password = document.getElementById("pass").value;
        var confirmPassword = document.getElementById("repass").value;
        var pin=parseInt(document.getElementById("spin").value);
        if (password != confirmPassword) {
            alert("Passwords do not match.");
            return false;
        }else if(!isInArray(pin, pins)) {
...
class="close" title="Close Modal">&times;</span>
  ...
  <form name="lform" class="modal-content animate" method="POST">
    <div class="imgcontainer">
      <img src="images/avatar2.jpg" style="margin-top:10%;opacity:70%"alt="Avatar" class="avatar">
    </div>

    <div class="container" style="width:450px">
      <input type="text" autocomplete="off" style="width:350px"placeholder="Enter Phone Number"  name="lphone" required autofocus> 
...
<div id="id02" class="modal">
      ...
      class="close" title="Close Modal">&times;</span>
        ...
        <form class="modal-content animate"  method="POST">
          ...
          <div class="container" style="width:500px;margin-top:-10%">
            ...
            <br><input type="text" placeholder="Enter PinCode" name="spin" id="spin" pattern="^[1-9][0-9]{5}$" title="Enter a Valid PinCode" style="width:350px" required>
          ...
          <div class="container" style="background-color:#f1f1f1">
            ...
            <button type="submit" name="ssubmit" style="text-align:center;float:right" onclick="return Validate();return checkPincode()" >Submit</button>
          </div>
        </form>
      </div>
            ...
            <div class="main-content-header">
                <h1><span style="font-size:300%;letter-spacing:20px"  class="dive" id="code"><span></span><span>RELISH</span><span id="code" class="dive" style="margin-left:-5%;font-size:25%">&#169;</span>
                </h1>
    ...
    <img class="img_sw" src="images/Capture.PNG" alt="Our Restaurant App" style="width:100%;height:100vh;" >
